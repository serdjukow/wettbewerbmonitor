...
import { Edit as EditIcon, Save as SaveIcon, Cancel as CancelIcon, DeleteForever as DeleteForeverIcon } from "@mui/icons-material"
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Stack spacing={2}>
                            ...
                            >
                                ...
                                <Button onClick={() => setIsEdit(!isEdit)} variant="outlined" startIcon={<CancelIcon />} color="warning">
                                    Cansel
                                </Button>
                                <Button onClick={removeCurrentCompany} variant="outlined" startIcon={<DeleteForeverIcon />} color="error">
                                    Delete
                                </Button>
                            </Box>
                        </Stack>
